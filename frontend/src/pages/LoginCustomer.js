...
const LoginCustomer = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex flex-col md:flex-row items-center justify-center px-4 py-12 gap-8">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="card">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Welcome back! Sign in to find services</p>
          </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-gray-600">
              ...
              <Link to="/register/customer" className="text-primary-600 hover:text-primary-700 font-semibold">
