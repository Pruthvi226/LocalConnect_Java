...
import { 
  ...
  LayoutDashboard, Settings, HelpCircle, Zap as ZapIcon, Star
} from 'lucide-react';
                    ...
                    {notificationOpen && (
                      ...
                      >
                        <div className="p-8 pb-4 flex justify-between items-center">
                          <div>
                             <h3 className="font-black text-slate-900 text-xl tracking-tight">Intelligence.</h3>
                             <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Life-cycle Alert Stack</p>
                          </div>
                        ...
                        <div className="max-h-[450px] overflow-y-auto invisible-scrollbar px-4 pb-8 space-y-2">
                          {notifications.length === 0 ? (
                            <div className="py-20 text-center px-12">
                               ...
                               <p className="text-slate-900 font-black text-sm uppercase tracking-tight">System Integrity 100%</p>
                               <p className="text-slate-400 text-xs mt-2 leading-relaxed">No anomalies or transmission requests detected in your current session.</p>
                            </div>
                          ) : (
              ...
              <div className="flex-1 space-y-2">
                {!isAuthenticated ? (
                  ...
                  <>
                     ...
                     <MenuItem icon={Settings} label="Settings" to="/settings" onClick={() => setMobileMenuOpen(false)} full />
